...
| `src/shared/api/`              | `src/api/`                                                                                                    | Global infra root.                                       | apiClient.ts → api/apiClient.ts.                                |
| `src/shared/query/`            | `src/query/`                                                                                                  | Global.                                                  | queryClient.ts → query/client.ts.                               |
| `src/shared/router/`           | `src/router/`                                                                                                 | Global.                                                  | routeTree.gen.ts update vite.config.ts.                         |
| `src/shared/config/`           | `src/config/`                                                                                                 | Global.                                                  | api.ts → config/api.ts.                                         |
| `src/shared/components/`       | `src/components/`                                                                                             | Root (keep ui/composites nested).                        | ui/button/ → components/ui/button/.                             |
| `src/shared/utils/`            | `src/utils/`                                                                                                  | Global.                                                  | cn(), contextFactory → utils/.                                  |
| `src/shared/styles/`           | `src/styles/`                                                                                                 | Global CSS.                                              | globals.css → styles/globals.css.                               |
| `src/shared/types/`            | `src/types/`                                                                                                  | Global.                                                  | api.ts → types/api.ts.                                          |
